...
num.times do
  ...
  when '1'
    ...
    Proin ut eleifend mi. Mauris ultricies turpis ac nibh eleifend tempus. Vivamus rutrum blandit est id porttitor."

  when '2'
    puts "Well, the way they make shows is, they make one show.
  ...
  when '3'
    puts "Glossier jean shorts jianbing, sartorial prism hell of 8-bit echo park tote bag distillery forage cold-pressed vaporware food truck. Chicharrones biodiesel microdosing, meditation hella put a bird on it ethical. Vaporware direct trade narwhal brooklyn, fap locavore pinterest.
    ...
    Post-ironic gentrify hoodie single-origin coffee vaporware fam. Mumblecore deep v swag venmo selvage."

  else
    puts 'Please select an option 1, 2, or 3 and then a multiplier'
  end
end
